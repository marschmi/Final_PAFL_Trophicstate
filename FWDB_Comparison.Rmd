...
nmds_bc_quad <- ggplot(nmds_bray, aes(MDS1*-100, MDS2*-100, color = quadrant, shape = limnion, size = ProdLevel)) +
  xlab("NMDS1") + ylab("NMDS2") + ggtitle("Bray-Curtis Dissimilarity") + 
  geom_point(alpha=0.9) + theme_bw() +   #geom_point(colour="white", size = 1) +
...
nmds_soren_quad <- ggplot(nmds_soren, aes(MDS1, MDS2, color = quadrant, shape = limnion, size = ProdLevel)) +
