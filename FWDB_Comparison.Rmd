...
g1 <- ggplot(bicompare_phy_nowin, aes(y=PercentAbund , x=Phylum, fill=filter)) + #coord_cartesian(xlim = c(0, 30)) + 
...
g2 <- ggplot(bicompare_phy_nowin, aes(y=PercentAbund , x=Phylum, fill=ProdLevel)) + #coord_cartesian(xlim = c(0, 30)) + 
...
g3 <- ggplot(bicompare_phy_nowin, aes(y=PercentAbund , x=Phylum, fill=limnion)) + #coord_cartesian(xlim = c(0, 30)) + 
...
#pdf(file="~/Final_PAFL_Trophicstate/FWDB_Figures/Phy15_comparison_mixed_green.pdf",  width= 7, height=6.5)
...
otu_sum_plot <- ggplot(otu_overlap, aes(y=NumOTUs , x=SampleType, fill=Type, order=Type)) +
  ...
  xlab("Sample Type ") + ylab("Sum of Shared or Unique OTUs") + 
