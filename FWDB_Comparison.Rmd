...
pvf_both <- semi_join(otu_abund_free_pruned, otu_abund_particle_pruned, by = "OTU") %>% # Overlap between PA and FL 
  mutate(SampleType = "Both PA and FL")
...
tvb_both <- semi_join(otu_abund_epi_pruned, otu_abund_hypo_pruned, by = "OTU") %>%  # Overlap between hypolimnion and epilimnion 
  mutate(SampleType = "Both Epi and Hypo")
...
hvl_both <- semi_join(otu_abund_low_pruned, otu_abund_high_pruned, by = "OTU") %>%  # Overlap between hypolimnion and epilimnion 
  mutate(SampleType = "Both Epi and Hypo")
