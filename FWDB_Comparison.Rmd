...
nmds_bc_quad <- ggplot(nmds_bray, aes(MDS1*-100, MDS2*-100, color = quadrant, shape = limnion, fill = ProdLevel)) +
  ...
  geom_point(aes(size=6, shape = limnion), show_guide = FALSE )+
  scale_color_manual(name = "Filter Fraction and Lake Layer", breaks=c("Free Epilimnion", "Free Mixed",  "Free Hypolimnion", "Particle Epilimnion", "Particle Mixed", "Particle Hypolimnion"),
                     labels = c("Free-Living Epilimnion (10)", "Free-Living Mixed (2)",  "Free-Living Hypolimnion (9)", "Particle-Associated Epilimnion (9)", "Particle-Associated Mixed (2)", "Particle-Associated Hypolimnion (9)"), 
                     values = c("orangered", "orangered", "orangered", "orangered4", "orangered4", "orangered4")) +
...
nmds_soren_quad <- ggplot(nmds_soren, aes(MDS1, MDS2, color = quadrant, shape = limnion, fill = ProdLevel)) +
