...
otu_proportions <- otu_overlap$Relative_OTU_Abund
...
```{r Fig 6 right panel - OTU summed relative to its abundance - alpha = 0.01, cutoff = 0 }
...
```{r Fig 6 left panel - proportion of sig over total OTUs per phylum}
# PANEL A - 
